...
.iv-app{min-height:100vh;background:#050510;color:#e8e0f0;font-family:'Cormorant Garamond',serif;overflow-x:hidden;position:relative;}
...
.iv-hero-eyebrow{font-family:'Space Mono',monospace;font-size:12px;letter-spacing:7px;color:#6EE7F9;text-transform:uppercase;margin-bottom:22px;}
.iv-hero-om{font-size:60px;display:block;margin-bottom:22px;filter:drop-shadow(0 0 28px rgba(212,175,55,.65));}
.iv-hero-title{font-family:'Cinzel Decorative',serif;font-size:clamp(48px,8vw,80px);font-weight:900;line-height:1.0;margin-bottom:18px;background:linear-gradient(135deg,#D4AF37 0%,#FAE27C 50%,#D4AF37 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:2px;}
.iv-hero-tagline{font-family:'Space Mono',monospace;font-size:12px;letter-spacing:6px;color:rgba(212,175,55,.7);text-transform:uppercase;margin-bottom:26px;}
...
.iv-ks-val{font-family:'Cinzel Decorative',serif;font-size:36px;color:#D4AF37;line-height:1;}
.iv-ks-lbl{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:3px;color:rgba(255,255,255,.45);text-transform:uppercase;margin-top:7px;}
...
.iv-nav-card.gold:hover{border-color:rgba(212,175,55,.5);background:rgba(212,175,55,.05);}
.iv-nav-card.purple:hover{border-color:rgba(139,92,246,.45);background:rgba(139,92,246,.05);}
.iv-nav-card.cyan:hover{border-color:rgba(110,231,249,.4);background:rgba(110,231,249,.04);}
.iv-nav-card.rose:hover{border-color:rgba(251,113,133,.4);background:rgba(251,113,133,.04);}
.iv-nc-icon{font-size:40px;margin-bottom:18px;display:block;}
.iv-nc-tag{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:3px;text-transform:uppercase;margin-bottom:10px;}
.gold .iv-nc-tag{color:rgba(212,175,55,.75);}
.purple .iv-nc-tag{color:rgba(167,139,250,.8);}
.cyan .iv-nc-tag{color:rgba(110,231,249,.75);}
.rose .iv-nc-tag{color:rgba(251,113,133,.8);}
.iv-nc-name{font-family:'Cinzel Decorative',serif;font-size:22px;color:#fff;margin-bottom:12px;}
.iv-nc-desc{font-size:17px;color:rgba(255,255,255,.55);line-height:1.68;font-style:italic;}
.iv-nc-arrow{position:absolute;top:28px;right:28px;color:rgba(212,175,55,.35);font-size:22px;transition:transform .3s,color .3s;}
.iv-nav-card:hover .iv-nc-arrow{transform:translateX(5px);color:#D4AF37;}

/* ── DIAGNOSIS SECTION ── */
.iv-diag-section{background:rgba(11,16,32,.75);border-top:1px solid rgba(212,175,55,.12);border-bottom:1px solid rgba(212,175,55,.12);padding:80px 48px;}
...
.iv-diag-heading{font-family:'Cinzel Decorative',serif;font-size:clamp(32px,4.5vw,50px);color:#D4AF37;line-height:1.15;margin-bottom:18px;}
...
.iv-hint:hover{background:rgba(212,175,55,.1);border-color:rgba(212,175,55,.45);transform:translateX(6px);}
...
.iv-voice-btn{background:rgba(110,231,249,.09);border:1px solid rgba(110,231,249,.28);border-radius:10px;padding:11px 20px;color:#6EE7F9;font-family:'Space Mono',monospace;font-size:11px;letter-spacing:2px;cursor:pointer;transition:all .3s;display:flex;align-items:center;gap:8px;}
.iv-voice-btn:hover{background:rgba(110,231,249,.18);}
.iv-voice-btn.listening{background:rgba(251,113,133,.14);border-color:rgba(251,113,133,.45);color:#fb7185;animation:pulse-anim 1s ease-in-out infinite;}
@keyframes pulse-anim{0%,100%{opacity:1;}50%{opacity:.4;}}
.iv-char{font-family:'Space Mono',monospace;font-size:11px;color:rgba(255,255,255,.35);margin-left:auto;}
.iv-textarea{width:100%;background:rgba(255,255,255,.05);border:1px solid rgba(255,255,255,.12);border-radius:16px;padding:22px;color:#fff;font-family:'Cormorant Garamond',serif;font-size:21px;line-height:1.75;resize:vertical;min-height:170px;outline:none;transition:border .3s;}
.iv-textarea:focus{border-color:#D4AF37;box-shadow:0 0 0 3px rgba(212,175,55,.12);}
.iv-textarea::placeholder{color:rgba(255,255,255,.28);font-style:italic;}
.iv-submit-btn{width:100%;background:linear-gradient(135deg,#D4AF37,#A8832A);color:#050510;border:none;border-radius:14px;padding:20px;font-family:'Space Mono',monospace;font-size:13px;letter-spacing:4px;text-transform:uppercase;cursor:pointer;font-weight:700;transition:all .3s;margin-top:20px;}
.iv-submit-btn:hover:not(:disabled){transform:translateY(-3px);box-shadow:0 14px 44px rgba(212,175,55,.45);}
.iv-submit-btn:disabled{opacity:.38;cursor:not-allowed;}
.iv-loading{text-align:center;padding:52px 0;}
.iv-loader{width:58px;height:58px;border:2px solid rgba(212,175,55,.15);border-top-color:#D4AF37;border-radius:50%;animation:iv-spin 1s linear infinite;margin:0 auto 20px;}
@keyframes iv-spin{to{transform:rotate(360deg);}}
.iv-loading-text{font-family:'Space Mono',monospace;font-size:12px;letter-spacing:4px;color:rgba(212,175,55,.7);text-transform:uppercase;}
.iv-err{background:rgba(251,113,133,.08);border:1px solid rgba(251,113,133,.25);border-radius:12px;padding:16px;color:#fb7185;font-family:'Space Mono',monospace;font-size:12px;text-align:center;margin-top:18px;}

/* ── REPORT ── */
.iv-report-wrap{background:rgba(5,5,16,.9);border-top:1px solid rgba(212,175,55,.14);}
...
/* Report header */
.iv-report-hdr{display:flex;align-items:flex-start;justify-content:space-between;flex-wrap:wrap;gap:18px;margin-bottom:52px;padding-bottom:32px;border-bottom:1px solid rgba(212,175,55,.15);}
.iv-report-title{font-family:'Cinzel Decorative',serif;font-size:clamp(30px,4vw,44px);color:#D4AF37;}
.iv-report-title span{display:block;font-size:15px;font-family:'Space Mono',monospace;letter-spacing:3px;color:rgba(255,255,255,.4);text-transform:uppercase;margin-top:8px;font-weight:400;}
.iv-report-badges{display:flex;gap:10px;flex-wrap:wrap;align-items:center;}
.iv-badge{display:inline-flex;align-items:center;border-radius:50px;padding:7px 20px;font-family:'Space Mono',monospace;font-size:10px;letter-spacing:2px;text-transform:uppercase;}
.iv-badge.karma-type{background:rgba(212,175,55,.13);border:1px solid rgba(212,175,55,.38);color:#FAE27C;}
.iv-badge.sev-gentle{background:rgba(0,255,170,.08);border:1px solid rgba(0,255,170,.3);color:#00ffaa;}
.iv-badge.sev-significant{background:rgba(255,170,0,.1);border:1px solid rgba(255,170,0,.32);color:#ffaa00;}
.iv-badge.sev-deep{background:rgba(251,113,133,.1);border:1px solid rgba(251,113,133,.32);color:#fb7185;}
.iv-badge.sev-breakthrough{background:rgba(139,92,246,.12);border:1px solid rgba(139,92,246,.42);color:#c4b5fd;}
...
.iv-card.gold-card{background:rgba(212,175,55,.04);border-color:rgba(212,175,55,.22);}
.iv-card.purple-card{background:rgba(139,92,246,.05);border-color:rgba(139,92,246,.22);}
.iv-card.cyan-card{background:rgba(110,231,249,.04);border-color:rgba(110,231,249,.2);}
.iv-card.dark-card{background:rgba(5,5,16,.7);border-color:rgba(255,255,255,.08);}
.iv-card-lbl{font-family:'Space Mono',monospace;font-size:11px;letter-spacing:4px;color:rgba(255,255,255,.45);text-transform:uppercase;margin-bottom:20px;display:block;}
.iv-card-title{font-family:'Cinzel Decorative',serif;font-size:24px;color:#D4AF37;margin-bottom:10px;}
.iv-card-body{font-size:19px;line-height:1.8;color:rgba(255,255,255,.85);}
.iv-card-body.italic{font-style:italic;}
.iv-card-body.gold{color:#FAE27C;}

/* Karma Snapshot */
.iv-snap-scores{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-bottom:22px;}
.iv-score-item{}
.iv-score-lbl{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:2px;color:rgba(255,255,255,.5);text-transform:uppercase;margin-bottom:9px;}
...
.iv-score-pct{font-family:'Space Mono',monospace;font-size:11px;color:rgba(255,255,255,.45);text-align:right;}
...
.iv-debt-lbl{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:2px;color:rgba(255,255,255,.45);text-transform:uppercase;}
.iv-debt-val{font-family:'Space Mono',monospace;font-size:12px;font-weight:700;letter-spacing:2px;}
.debt-Low{color:#00ffaa;}
.debt-Medium{color:#ffaa00;}
.debt-High{color:#fb7185;}
.iv-cycle{display:inline-block;background:rgba(212,175,55,.13);border:1px solid rgba(212,175,55,.32);border-radius:50px;padding:7px 18px;font-family:'Space Mono',monospace;font-size:10px;letter-spacing:2px;color:#D4AF37;margin-top:16px;}

/* Timeline */
.iv-tl{display:flex;flex-direction:column;}
.iv-tl-item{display:flex;gap:20px;position:relative;}
.iv-tl-line{position:absolute;left:19px;top:44px;bottom:0;width:1px;background:linear-gradient(to bottom,rgba(212,175,55,.35),transparent);}
.iv-tl-dot{width:40px;height:40px;border-radius:50%;border:1.5px solid rgba(212,175,55,.45);background:rgba(212,175,55,.08);display:flex;align-items:center;justify-content:center;font-size:17px;flex-shrink:0;margin-top:3px;}
.iv-tl-body{flex:1;padding-bottom:30px;}
.iv-tl-lbl{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:3px;color:rgba(212,175,55,.65);text-transform:uppercase;margin-bottom:9px;}
...
.iv-lesson:hover{border-color:rgba(212,175,55,.3);}
.iv-lesson-num{font-family:'Cinzel Decorative',serif;font-size:32px;color:rgba(212,175,55,.22);flex-shrink:0;line-height:1;min-width:44px;}
...
.iv-rem-card:hover{border-color:rgba(212,175,55,.35);transform:translateY(-4px);background:rgba(212,175,55,.04);}
.iv-rem-icon{font-size:32px;margin-bottom:14px;display:block;}
.iv-rem-type{font-family:'Space Mono',monospace;font-size:11px;letter-spacing:2px;color:rgba(212,175,55,.65);text-transform:uppercase;margin-bottom:8px;}
...
.iv-week-check{width:24px;height:24px;border-radius:50%;border:1px solid rgba(0,255,170,.38);background:rgba(0,255,170,.08);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:#00ffaa;font-size:12px;margin-top:3px;}
...
.iv-planet-name{font-family:'Cinzel Decorative',serif;font-size:20px;color:#fff;margin-bottom:10px;}
.iv-planet-inf{font-family:'Space Mono',monospace;font-size:10px;letter-spacing:2px;border-radius:50px;padding:5px 16px;margin:0 auto 12px;display:inline-block;}
.inf-Strong{background:rgba(0,255,170,.1);border:1px solid rgba(0,255,170,.32);color:#00ffaa;}
.inf-Moderate{background:rgba(212,175,55,.1);border:1px solid rgba(212,175,55,.3);color:#D4AF37;}
.inf-Challenging{background:rgba(251,113,133,.1);border:1px solid rgba(251,113,133,.3);color:#fb7185;}
.iv-planet-note{font-size:16px;color:rgba(255,255,255,.58);line-height:1.62;font-style:italic;}

/* Sacred quote */
.iv-quote{background:linear-gradient(135deg,rgba(212,175,55,.08),rgba(139,92,246,.07));border:1px solid rgba(212,175,55,.2);border-radius:24px;padding:56px 52px;text-align:center;position:relative;overflow:hidden;margin-bottom:22px;}
@media(max-width:768px){.iv-quote{padding:40px 28px;}}
.iv-quote-deco{position:absolute;font-family:serif;font-size:160px;color:rgba(212,175,55,.05);line-height:1;user-select:none;}
.iv-quote-deco.l{left:12px;top:-10px;}
.iv-quote-deco.r{right:12px;bottom:-30px;}
.iv-quote-lbl{font-family:'Space Mono',monospace;font-size:11px;letter-spacing:5px;color:rgba(212,175,55,.6);text-transform:uppercase;margin-bottom:24px;}
.iv-quote-txt{font-family:'Cinzel Decorative',serif;font-size:clamp(20px,3vw,32px);color:#FAE27C;line-height:1.65;position:relative;z-index:1;}

/* Reset */
.iv-reset-btn{width:100%;background:transparent;border:1px solid rgba(212,175,55,.28);border-radius:14px;padding:18px;color:rgba(212,175,55,.75);font-family:'Space Mono',monospace;font-size:12px;letter-spacing:3px;text-transform:uppercase;cursor:pointer;transition:all .3s;}
.iv-reset-btn:hover{background:rgba(212,175,55,.08);color:#D4AF37;border-color:rgba(212,175,55,.5);}
`;
  ...
  useEffect(() => {
    ...
    const frame = () => {
      ...
      for (let i = shoots.length - 1; i >= 0; i--) {
        ...
        grad.addColorStop(0.6, `rgba(212,175,55,${s.life * 0.5})`);
    ...
    <div className="iv-report iv-report-anim">
      ...
      <div className="iv-report-hdr">
        ...
        <div className="iv-report-badges">
          ...
          {result.lifeDomain && <span className="iv-badge" style={{background:"rgba(110,231,249,.08)",border:"1px solid rgba(110,231,249,.25)",color:"#6EE7F9"}}>{result.lifeDomain}</span>}
        </div>
      </div>
      ...
      <div className="iv-row iv-row-3">
        ...
        <div className="iv-card gold-card">
          ...
          <div className="iv-snap-scores">
            <ScoreBar label="Spiritual" value={ks.spiritual} gradient="linear-gradient(90deg,#D4AF37,#FAE27C)" />
            <ScoreBar label="Discipline" value={ks.discipline} gradient="linear-gradient(90deg,#6EE7F9,#38bdf8)" />
            <ScoreBar label="Compassion" value={ks.compassion} gradient="linear-gradient(90deg,#fb7185,#f43f5e)" />
          </div>
        ...
        <div className="iv-card">
          ...
          {result.remedyUrgency && (
            <div style={{marginTop:20,fontFamily:"'Space Mono',monospace",fontSize:11,letterSpacing:2,color:"rgba(110,231,249,.8)",textTransform:"uppercase"}}>
