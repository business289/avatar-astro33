    ...
    <DevotionLayout>
      <div className="relative z-10" ref={pageRef}>
        ...
        <section
          ...
          style={{ paddingTop: 100, paddingBottom: 56 }}
        >
          <div
            style={{
              maxWidth: 900,
          ...
          >
            ...
            <div className="flex items-center justify-center gap-3 mb-5">
              <div
                style={{
                  ...
                  width: 56,
                  background:
                    "linear-gradient(to right, transparent, rgba(188,106,77,0.5))",
                }}
              />
              <p
                style={{
              ...
              <div
                style={{
                  ...
                  width: 56,
                  background:
                    "linear-gradient(to left, transparent, rgba(188,106,77,0.5))",
                }}
              />
            </div>

            <h1
              className="shop-hero-title font-display font-bold tracking-widest uppercase leading-none mb-5"
            ...
            >
              ...
              <span
                style={{
                  background:
                    "linear-gradient(135deg, #BC6A4D 0%, #BC6A4D 60%, #BC6A4D 100%)",
            ...
            >
              Authentic spiritual products — gemstones, rudraksha, yantras,
              <br />
              and sacred prasad
            </p>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={{
                    ...
                    borderRadius: 16,
                    boxShadow: "0 4px 20px rgba(188,106,77,0.08)",
                    outline: "none",
                  }}
                  onFocus={(e) => {
                    (e.target as HTMLInputElement).style.borderColor =
                      "rgba(188,106,77,0.55)";
                  }}
                  onBlur={(e) => {
                    (e.target as HTMLInputElement).style.borderColor =
                      "rgba(188,106,77,0.22)";
                  }}
                />
              </div>
            </div>
        ...
        <div className="pb-16">
          {/* ── Category filter ───────────────────────────────────────────────── */}
          <div
            className="sticky top-[68px] z-40 py-4 border-b border-[#E8DED0]"
            style={{
              ...
              >
                {filtered.map((product) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <h3
                        className="font-display text-sm tracking-wider uppercase mb-2 line-clamp-1 group-hover:text-[#BC6A4D] transition-colors duration-300"
                        style={{ color: "#2C1810" }}
                      >
                        {product.name}
                      </h3>
