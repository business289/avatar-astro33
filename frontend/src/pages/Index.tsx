...
import {
  ArrowRight, Star, Eye, Heart, Sparkles, Shield,
} from "lucide-react";
    ...
    <div className="relative">
      <div className="relative z-10">
        ...
        <section ref={featuresRef} className="relative z-10 py-24">
          <div className="container mx-auto px-6 lg:px-16">
            ...
            <div className="text-center mb-16">
              <h2
                className="font-display text-5xl md:text-6xl font-bold tracking-widest uppercase mb-4 leading-none"
              >
        ...
        <section className="relative z-10 py-16 flex flex-col items-center text-center px-6">
          ...
          >
            ...
            <div
              ...
              style={{
                background: "radial-gradient(ellipse at center, rgba(18,58,117,0.25) 0%, transparent 70%)",
              }}
            />
        ...
        <section
          ...
          style={{ padding: "94px 53px 144px 53px", gap: 109, maxWidth: 1690, margin: "0 auto" }}
        >
            {/* Heading */}
            ...
            <div className="flex flex-col w-full" style={{ gap: 12 }}>
              {offerRows.map((row, rowIdx) => (
                <div
                  key={rowIdx}
                  className="offer-row"
                  style={{ "--cols": row.map(item => `${item.flex}fr`).join(" ") } as React.CSSProperties}
                >
          ...
          <div style={{ padding: '20px 71px 20px 72px' }}>
            <div
              style={{
                ...
                overflow: 'hidden',
                borderRadius: 20,
                background: 'linear-gradient(160deg, rgba(13,43,94,0.72) 0%, rgba(7,21,58,0.78) 50%, rgba(5,13,38,0.85) 100%)',
            ...
            >
              ...
              <div className="pointer-events-none select-none" style={{ position: 'absolute', top: -30, left: -233, width: 720, height: 480, zIndex: 0 }}>
                <img
                  src={sunMoonImg}
                  alt="Sun and Moon"
                  style={{
                    width: 720, height: 480, objectFit: 'contain',
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-start w-full" style={{ padding: '50px 80px', position: 'relative', zIndex: 1 }}>

                {/* LEFT — all content aligned to the right of the logo */}
                <div style={{ paddingLeft: 180, paddingTop: 40 }}>

                  {/* Badge */}
                  <div className="inline-flex items-center gap-2" style={{ color: '#BC6A4D', marginBottom: 14 }}>
                    <Shield className="w-5 h-5" />
                    <span style={{ fontSize: 15, letterSpacing: '0.28em', textTransform: 'uppercase' }}>Trust & Accuracy</span>
                  </div>

                  {/* Headings — directly below badge */}
                  <h2 className="font-display tracking-wider leading-tight"
                    style={{ fontSize: 52, fontWeight: 500, color: '#ffffff', marginBottom: 4 }}>
                    WHY TRUST
                  </h2>
                  <h2 className="font-display tracking-wider leading-tight"
                    style={{ fontSize: 52, fontWeight: 500, color: '#BC6A4D', marginBottom: 20 }}>
                    OUR ASTROLOGY
                  </h2>

                  {/* Description */}
                  <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.6)', maxWidth: 400, lineHeight: 1.7, marginBottom: 28 }}>
                  ...
                  <Link
                    ...
                    style={{ color: '#ffffff', fontSize: 15, textDecoration: 'underline', textUnderlineOffset: 4 }}
                  >
                    Learn More
                  ...
                  {trustReasons.map((reason, index) => (
                    <div
                      ...
                      style={{
                        ...
                        borderRadius: 14,
                        background: 'linear-gradient(160deg, rgba(13,43,94,0.95) 0%, rgba(7,21,58,0.97) 50%, rgba(5,13,38,0.98) 100%)',
                        padding: '18px 24px',
                        minHeight: 88,
                      }}
                    >
                      <span className="flex-shrink-0" style={{ color: '#BC6A4D', fontSize: 26, lineHeight: 1 }}>✳</span>
                      <div>
                        <h4 className="font-display tracking-wider text-white mb-1.5" style={{ fontSize: 32, fontWeight: 500 }}>
                          {reason.title}
                        </h4>
                        <p style={{ fontSize: 17, color: 'rgba(255,255,255,0.5)', lineHeight: 1.5 }}>
                          {reason.description}
                        </p>
                      </div>
                    </div>
          ...
          <div style={{ width: 1282, margin: '0 auto', position: 'relative' }}>
            ...
            >
              <h2
                ...
                style={{ fontSize: 56, fontWeight: 700, lineHeight: 1.15, letterSpacing: '0.06em', marginBottom: 28 }}
              >
                UNLOCK YOUR<br />COSMIC PATH
              </h2>

              <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.65)', lineHeight: 1.7, marginBottom: 44, maxWidth: 480 }}>
                Subscribe To Get Personalized Horoscopes And<br />
